...
load("F:\ycy\修改\分类\1D-CNN\idxTrain.mat")
load('F:\ycy\修改\分类\1D-CNN\idxValidation.mat')
%%
np = 181;
...
layers = [ ...
    sequenceInputLayer(2,MinLength=np)
...
for i = 1:k
    ...
    cv_accuracy(i) = compute_accuracy(t_val, Yval);
end
